...
class GalleryController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $images->getCollection()->transform(function ($image) {
            $image->url = app(\App\Services\Core\ImageService::class)->getDynamicUrl($image, 800);
            $image->original_url = app(\App\Services\Core\ImageService::class)->getDynamicUrl($image);
            return $image;
        });
