        ...
        <div class="py-12">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div style="margin-bottom: 32px;">
                    ...
                    <h1 style="font-size: 26px; font-weight: 700; color: #f1f3f9; margin: 0;">المؤقت الذكي</h1>
                </div>

                <div style="background: #13151c; border: 1px solid #1e2130; border-radius: 16px; padding: 40px; text-align: center;">
                    <div style="font-size: 48px; margin-bottom: 20px;">⏱️</div>
                    <h2 style="color: #f1f3f9; font-size: 20px; font-weight: 700; margin-bottom: 12px;">ميزة المؤقت قيد التطوير</h2>
                    <p style="color: #8891aa; font-size: 14px; max-width: 400px; margin: 0 auto; line-height: 1.6;">
                        قريباً ستتمكن من تتبع وقتك وإدارة جلسات التركيز الخاصة بك مباشرة من هنا.
                    </p>
